...
const HabitRenderer = ({ open, handleOpenDialog, close, handleSubmit, hover, expanded, handleExpandIconClick, img, alt, type, habitRenderer, handleCheckboxClick, dateKey, dayKey, checkedHabits, isAddingHabit }) => {
    return (
        <div className="main">
            ...
            <Popup open={open} close={close} isAddingHabit={isAddingHabit} handleSubmit={handleSubmit} habitRenderer={habitRenderer} handleCheckboxClick={handleCheckboxClick} dateKey={dateKey} dayKey={dayKey} checkedHabits={checkedHabits} />
            {!expanded && (
