...
const HabitTracker = () => {
  ...
  const getCurrentWeekDays = (option) => {
  ...
  const initialMorningHabitRenderer = [
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f938.png",
      habit: "Stretch",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/2696.png",
      habit: "Measure Weight",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f976.png",
      habit: "Cold shower",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f95b.png",
      habit: "Protein shake",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4aa.png",
      habit: "Workout",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4d6.png",
      habit: "Read 15 min",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/270d.png",
      habit: "Morning journal",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4f5.png",
      habit: "No social/news 1hr after waking up",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f9d8-200d-2642-fe0f.png",
      habit: "Breathing exercise",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4a7.png",
      habit: "Bottle of water in the morning",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/2600.png",
      habit: "Sunlight 10 min",
    },
  ];
  const initialAfterNoonRenderer = [
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f37d.png",
      habit: "Fasting for 16 hrs",
    },
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f916.png",
      habit: "3+ hours of coding",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f49a.png",
      habit: "Athletic Greens",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4aa.png",
      habit: "Workout",
    ...
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f4e7.png",
      habit: "Inbox Zero",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4a7.png",
      habit: "Bottle of water",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f9d8-200d-2642-fe0f.png",
      habit: "Mindful",
  ...
  const initialEveningRenderer = [
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/2705.png",
      habit: "One personal task",
    },
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f436.png",
      habit: "Quality time with pet",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f916.png",
      habit: "3+ hours of coding",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f9d8-200d-2642-fe0f.png",
      habit: "Mindful meditation",
    },
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f4a7.png",
      habit: "Bottle of Water",
    },
    {
      img: "https://twemoji.maxcdn.com/v/14.0.1/72x72/1f4aa.png",
      habit: "Workout",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f4d6.png",
      habit: "Reading 15 min",
    },
  ];
  const initialAnyTimeRenderer = [
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f938.png",
      habit: "Stretch",
    },
    ...
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/2615.png",
      habit: "Coffee",
    },
    {
      img: "https://cdn.jsdelivr.net/gh/twitter/twemoji@v14.0.1/assets/72x72/1f957.png",
      habit: "Log meals for day",
    },
  ];
  const [morningHabitRenderer, setMorningHabitRenderer] = useState(() => {
    const storedHabits = JSON.parse(localStorage.getItem("newHabits")) || [];
  ...
  useEffect(() => {
    const storedHabits = JSON.parse(localStorage.getItem("newHabits")) || [];
    setMorningHabitRenderer([...initialMorningHabitRenderer, ...storedHabits]);
  }, [localStorage.getItem("newHabits")]);
  ...
  useEffect(() => {
    const storedHabits =
      JSON.parse(localStorage.getItem("newAfterNoonHabits")) || [];
    setAfterNoonHabitRenderer([...initialAfterNoonRenderer, ...storedHabits]);
  }, [localStorage.getItem("newAfterNoonHabits")]);
  ...
  useEffect(() => {
    const storedHabits =
      JSON.parse(localStorage.getItem("newEveningHabits")) || [];
    setEveningHabitRenderer([...initialEveningRenderer, ...storedHabits]);
  }, [localStorage.getItem("newEveningHabits")]);
  const [anyTimeHabitRenderer, setAnyTimeHabitRenderer] = useState(() => {
    const storedHabits =
  ...
  useEffect(() => {
    const storedHabits =
      JSON.parse(localStorage.getItem("newAnyTimeHabits")) || [];
    setAnyTimeHabitRenderer([...initialAnyTimeRenderer, ...storedHabits]);
  }, [localStorage.getItem("newAnyTimeHabits")]);
  ...
  const handleEveningCheckboxClick = (index) => {
    ...
    // setNewSelectedHabit(selectedHabit);
    ...
    setClickedAfterNoonHabitIndex((prevClickedAfterNoonHabits) => {
      if (prevClickedAfterNoonHabits[dayOfWeek]?.includes(index)) {
        return {
          ...
          [dayOfWeek]: prevClickedAfterNoonHabits[dayOfWeek].filter(
            (i) => i !== index
          ),
        };
      } else {
        return {
          ...prevClickedAfterNoonHabits,
          [dayOfWeek]: [
            ...(prevClickedAfterNoonHabits[dayOfWeek] || []),
            index,
          ],
        };
      }
    ...
    setClickedEveningHabitIndex((prevClickedEveningHabits) => {
      if (prevClickedEveningHabits[dayOfWeek]?.includes(index)) {
        return {
          ...
          [dayOfWeek]: prevClickedEveningHabits[dayOfWeek].filter(
            (i) => i !== index
          ),
        };
      } else {
    ...
    setClickedAnyTimeHabitIndex((prevClickedAnyTimeHabits) => {
      if (prevClickedAnyTimeHabits[dayOfWeek]?.includes(index)) {
        return {
          ...
          [dayOfWeek]: prevClickedAnyTimeHabits[dayOfWeek].filter(
            (i) => i !== index
          ),
        };
      } else {
  ...
  useEffect(() => {
    localStorage.setItem(
      "clickedHabitIndex",
      JSON.stringify(clickedHabitIndex)
    );
    localStorage.setItem(
      "clickedAfterNoonHabitIndex",
      JSON.stringify(clickedAfterNoonHabitIndex)
    );
    localStorage.setItem(
      "clickedEveningHabitIndex",
      JSON.stringify(clickedEveningHabitIndex)
    );
    localStorage.setItem(
      "clickedAnyTimeHabitIndex",
      JSON.stringify(clickedAnyTimeHabitIndex)
    );
  }, [
    clickedHabitIndex,
    clickedAfterNoonHabitIndex,
  ...
  const mondayHabits = filterMondayHabits(mondayCheckedItems);
  return (
        ...
        {selectedTab === 0 && (
          <div style={{ position: "relative", marginTop: "20px" }}>
            ...
            <AddHabit
              ...
              setMorningHabitRenderer={setMorningHabitRenderer}
                ...
                {anyTimeHabitRenderer.map((item, index) => {
                  return (
                    <tr
                      key={index}
                      style={{
                        height: isMobileResponsive ? "38px" : "45px",
                        display: "table-row",
                        borderBottom: "0.0625rem solid #c1c2c5",
                      }}
                    >
                      <td style={{ padding: "6px 0" }}>
                        ...
                        >
                          <img
                            style={{
                              width: isMobileResponsive ? "14px" : "18px",
                              height: isMobileResponsive ? "14px" : "18px",
                            }}
                            alt="rainbow"
                            src={item.img}
                          />
                      ...
                      {weekDays.map((day, dayIndex) => {
                        ...
                        const habitsAfterNoon =
                          afterNoonHabits[day.dateKey] || [];
                        ...
                        const isAfterNoonForDay = habitsAfterNoon.includes(
                          item.habit
                        );
                        const isEveningForDay = habitsEvening.includes(
                          item.habit
                        );
                        const isAnyTimeForDay = habitsAnyTime.includes(
                          item.habit
                        );
                        return (
                          <td
                            key={dayIndex}
                            style={{
                              padding: isMobileResponsive ? "6px 0" : "7px 0",
                            }}
                          >
                            <div
                              style={{
                                ...
                                borderRadius: "7px",
                                backgroundImage:
                                  isHabitPresentForDay ||
                                  isAfterNoonForDay ||
                                  isEveningForDay ||
                                  isAnyTimeForDay
                                    ? "linear-gradient(45deg, rgb(103, 63, 217) 0%, rgb(194, 37, 92) 100%)"
                                    : "none",
                                backgroundColor:
                                  isHabitPresentForDay ||
                                  isAfterNoonForDay ||
